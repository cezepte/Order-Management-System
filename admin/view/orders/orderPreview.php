 ...
 <div role="alert" aria-live="assertive" aria-atomic="true" class="toast shadow bg-white" id="orderPreview">
            ...
            <form action="#" method="post">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <div class="mt-2 pt-2 m-0">
                            <button type="submit" class="btn btn-success btn-sm">Zatwierdź</button>
                            <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="toast" onclick="document.getElementById('orderPreview').style.display = 'none';">Zamknij</button>
                        </div>
                    </td>
                </tr>
            </form>
